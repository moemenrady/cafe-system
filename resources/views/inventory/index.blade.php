    ...
    <div class="container mx-auto px-6 py-8" dir="rtl">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <a href="{{ route('inventory.create') }}"
                class="bg-blue-600 text-white px-5 py-2.5 rounded-xl font-medium shadow-lg shadow-blue-200 hover:bg-blue-500 hover:shadow-none transition-all duration-300">
                إضافة خامة جديدة +
            </a> <a href="{{ route('inventory.movements') }}"
                class="bg-gray-600 text-white px-5 py-2.5 rounded-xl font-medium shadow-lg shadow-gray-200 hover:bg-gray-500 hover:shadow-none transition-all duration-300">
                سجل حركات الخامات
            </a>
        </div>
