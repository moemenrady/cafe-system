                ...
                <div class="bg-white rounded-2xl border shadow-sm overflow-hidden transition-all
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-start justify-between mb-3">
                            <div>
                                <a href="{{ route('tables.show', $table->id) }}" class="font-black text-gray-800 text-base hover:text-blue-600 transition flex items-center gap-1.5">
                                    <span>{{ $table->name }}</span>
                                    <i class="fa-solid fa-arrow-up-left-from-square text-[10px] text-gray-400"></i>
                                </a>
                                @if($table->area)
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="{{ route('tables.show', $table->id) }}"
                               class="w-9 h-9 flex items-center justify-center rounded-xl bg-blue-50 text-blue-600 hover:bg-blue-100 transition border border-blue-100"
                               title="عرض تفاصيل الطاولة والطلبات">
